...
void main() {
  ...
  // Base canvas dark Muvuca (#070708)
  vec3 col = vec3(0.027, 0.027, 0.031); 

  col += u_colors[0] * smoothstep(0.1, 1.0, n1) * 0.4;
  col += u_colors[1] * light * 0.8;
...
/**
 * Paleta padrão Muvuca:
 * - Lime 400 (#A3E635): Brand Primary
 * - Lime 600 / 700 (#65A30D): Focus / Contenção
 * - Dark Surface (#111013): Fundo / Profundidade
 */
