...
export function NavLink({ item }: { item: NavItem }) {
  ...
  return (
    <Link
      ...
      className={cn(
        "group flex h-10 items-center justify-between gap-2.5 rounded-md px-3 py-2 transition-colors duration-(--motion-fast) ease-out-muvuca focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:outline-none motion-reduce:transition-none",
        isActive
